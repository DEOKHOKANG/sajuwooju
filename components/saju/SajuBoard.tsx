  ...
  return (
    <div className="w-full max-w-4xl mx-auto mb-12">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">당신의 천간지지 (天干地支)</p>
      </div>

      {/* 사주판 */}
      <div className="relative bg-gradient-to-br from-amber-50 via-white to-orange-50 rounded-3xl shadow-2xl p-8 border-4 border-amber-200">
        {/* 장식 코너 */}
        <div className="absolute top-4 left-4 w-8 h-8 border-t-4 border-l-4 border-amber-400 rounded-tl-lg" />
        <div className="absolute top-4 right-4 w-8 h-8 border-t-4 border-r-4 border-amber-400 rounded-tr-lg" />
        <div className="absolute bottom-4 left-4 w-8 h-8 border-b-4 border-l-4 border-amber-400 rounded-bl-lg" />
        <div className="absolute bottom-4 right-4 w-8 h-8 border-b-4 border-r-4 border-amber-400 rounded-br-lg" />

        {/* 네 기둥 그리드 */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {pillars.map((pillar) => (
            <PillarColumn key={pillar.title} pillar={pillar} />
          ))}
        </div>
        ...
        <div className="mt-8 pt-6 border-t-2 border-amber-200">
          <div className="text-center">
            <span className="text-gray-600 text-sm">띠</span>
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="text-center mb-3">
        <div className="text-lg font-bold text-gray-800">{pillar.title}</div>
      ...
      <div className="w-full mb-2">
        <div
          ...
          `}
        >
          <div className="text-4xl font-bold text-center">{pillar.gan}</div>
      ...
      <div className="w-full">
        <div
          ...
          `}
        >
          <div className="text-4xl font-bold text-center">{pillar.zhi}</div>
      ...
      {/* 연결선 */}
      <div className="w-0.5 h-3 bg-amber-300 my-2" />
    </div>
  );
}
