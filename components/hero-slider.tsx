...
export function HeroSlider({
  ...
  return (
    <div
      ref={sliderRef}
      className="flex gap-4 overflow-x-auto snap-x snap-mandatory scrollbar-hide -mx-4 px-4 touch-pan-x"
    ...
    >
      {slides.map((slide, i) => (
        <div
          key={i}
          className="flex-shrink-0 snap-center overflow-hidden relative w-full aspect-square"
          style={{
            borderRadius: '20px',
            maxWidth: '600px'
          }}
